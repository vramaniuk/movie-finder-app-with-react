      ...
      <div className="MovieDetails">
        ...
        <div className="MovieDetails__info-container">
          ...
          <div className="MovieDetails__short-info">
            ...
            <div className="info__item info__budget"><b>Budget:</b> {formatMoney(movie.budget)}
            </div>
            <div className="info__item info__release_date"><b>Release
              date:</b> {formatDate(movie.release_date)}
            </div>
            <div className="info__item info__revenue"><b>Revenue:</b> {formatMoney(movie.revenue)}
            </div>
